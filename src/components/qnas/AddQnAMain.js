            ...
            <div className="col-xl-12 col-lg-12">
              <div className="card mb-4 shadow-sm">
                <div className="card-body">
                  ...
                  <div className="mb-4">
                    <select className="form-control mt-3" name="departmentId" value={formik.values.departmentId} onChange={formik.handleChange}>
                      <option value="">Department</option>
                      { departmentCd?.length === undefined ? 
                        <option key={departmentCd?._id} value={departmentCd?._id}>{departmentCd?.name}</option>
                        :
