...
const EditTreatmentMain = () => {
  ...
  const { addSuccess, error, treatment } = useSelector((state) => state.treatment);
  ...
  }, [dispatch, queryPreliminary, addSuccess, error, queryDiagnose, id]);
  ...
  const formik = useFormik({
    initialValues: {
      ...
      preliminary: treatment?.preliminary,
