...
const MainDepartment = () => {
  ...
  const { pending, listDepartment, deleteSuccess, maxPage, page } = useSelector(
              ...
              <ul className="pagination">
                <li className={`page-item ${page == 1 ? "disabled" : ""} `}>
                  <Link
                    className="page-link"
                    to="#"
                    onClick={() => dispatch(decrementDepartment())}
                  >
                    Previous
                  </Link>
                </li>
